                            ...
                            <div class="example">
                                <div class="tab-content rounded-bottom">
                                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-267">
                                        <form class="row g-3"
                                            action="{{ route('siswa.surat-masuk.update', $surat_masuk->id) }}"
                                            ...
                                            <div class="col-md-4">
                                                <iframe
                                                    src="{{ url(Storage::url('public/dokumen/' . $surat_masuk->dokumen)) }}"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input class="form-control @error('perihal_surat') is-invalid @enderror"
                                                    ...
                                                    value="{{ $surat_masuk->perihal_surat }}">
                                                @error('perihal_surat')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-5">
                                                ...
                                                <input class="form-control @error('tanggal_input') is-invalid @enderror"
                                                    ...
                                                    value="{{ $surat_masuk->tanggal_input }}">
                                                @error('tanggal_input')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
