<header class="header header-sticky mb-4">
    <div class="container-fluid">
        ...
        <ul class="header-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#">
                    <svg class="icon icon-lg">
                        <use xlink:href="{{ asset('core-ui') }}/vendors/@coreui/icons/svg/free.svg#cil-envelope-open">
                        </use>
                    </svg></a></li>
        </ul>
            ...
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#"
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-light py-2">
                        ...
                        <svg class="icon me-2">
                            <use
                                xlink:href="{{ asset('core-ui') }}/vendors/@coreui/icons/svg/free.svg#cil-comment-square">
                            </use>
                    ...
                    <div class="dropdown-header bg-light py-2">
                        ...
                        <svg class="icon me-2">
                            <use xlink:href="{{ asset('core-ui') }}/vendors/@coreui/icons/svg/free.svg#cil-settings">
                            </use>
                        </svg> Settings</a><a class="dropdown-item" href="#">
                        <svg class="icon me-2">
                            <use
                                xlink:href="{{ asset('core-ui') }}/vendors/@coreui/icons/svg/free.svg#cil-credit-card">
                            </use>
